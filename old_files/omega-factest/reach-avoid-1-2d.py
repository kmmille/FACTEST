...
modelPath = currFile.replace('/synthesis/FACTEST/omega_FACTEST/reach-avoid-1-2d.py', '')
sys.path.append(modelPath)
sys.path.append(modelPath+'/utils/')
modelPath = currFile.replace('/reach-avoid-1-2d.py', '')
sys.path.append(modelPath)
...
if system == 'car':
    my_id = "myCar"
    my_code = None
    my_filename = currFile.replace('synthesis/FACTEST/omega_FACTEST/reach-avoid-1-2d.py', 'models/dubins/dubinsControl_2dKinematic.py')
    ...
    my_id = "myRobot"
    my_code = None
    my_filename = currFile.replace('synthesis/FACTEST/omega_FACTEST/reach-avoid-1-2d.py', 'models/dubins/bijectiveControl.py')
...
E5 = pc.Polytope(A, b_unsafe1) # unsafe border 1
E6 = pc.Polytope(A, b_unsafe2) # unsafe border 2
E7 = pc.Polytope(A, b_unsafe3) # unsafe border 3
E8 = pc.Polytope(A, b_unsafe4) # unsafe border 4
...
# hybridAutomaton = getHybrid(buchi_states, buchi_inits, buchi_AP, buchi_alphabet, buchi_transitions, buchi_acceptances, buchi_run, env, my_car, initial_set, border_sets=[E5,E6,E7,E8])
...
hybrid = constructFullHybrid(ltl_formula=ltl_formula, env=env, system=my_car, initial_set=initial_set, border_sets=[E5,E6,E7,E8])
...
import csv
with open('/Users/krismiller/Desktop/dissertation/synthesis/FACTEST/omega_FACTEST/results/RA1_'+system+'.csv', 'w', newline='') as csvfile:

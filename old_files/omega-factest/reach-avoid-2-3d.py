...
modelPath = currFile.replace('/synthesis/FACTEST/omega_FACTEST/reach-avoid-2-3d.py', '')
...
if system == 'hovercraft':
    ...
    my_id = "myCar"
    my_code = None
    my_filename = currFile.replace('synthesis/FACTEST/omega_FACTEST/reach-avoid-2-3d.py', 'models/dubins/hovercraftControl.py')
    ...
    my_id = "myCar"
    my_code = None
    my_filename = currFile.replace('synthesis/FACTEST/omega_FACTEST/reach-avoid-2-3d.py', 'models/dubins/auvControl.py')
...
b_goal4 = np.array([6.5,-5.5,-5.5,6.5,6.5,-5.5])
...
E3 = pc.Polytope(A, b_goal3) # goal set 1
E4 = pc.Polytope(A, b_goal4) # goal set 2

E5 = pc.Polytope(A, b_unsafe5) # unsafe set 1
E6 = pc.Polytope(A, b_unsafe6) # unsafe set 2

E7 = pc.Polytope(A, b_unsafe1)
E8 = pc.Polytope(A, b_unsafe2)
E9 = pc.Polytope(A, b_unsafe4)
E10 = pc.Polytope(A, b_unsafe3)
E11 = pc.Polytope(A, b_unsafe7)
E12 = pc.Polytope(A, b_unsafe8)

env = {'E1':E1, 'E2':E2, 'E3':E3, 'E4':E4, 'E5':E5, 'E6':E6}
borders = [E7, E8, E9, E10, E11, E12]
...
import csv
with open('/Users/krismiller/Desktop/dissertation/synthesis/FACTEST/omega_FACTEST/results/RA5_'+system+'.csv', 'w', newline='') as csvfile:

...
modelPath = currFile.replace('/synthesis/FACTEST/omega_FACTEST/reach-avoid-2-2d.py', '')
sys.path.append(modelPath)
# modelPath = currFile.replace('/reach-avoid-2-2d.py', '')
# sys.path.append(modelPath)
...
# from utils.plotting import plotPoly
...
if system == 'car':
    my_id = "myCar"
    my_code = None
    my_filename = currFile.replace('synthesis/FACTEST/omega_FACTEST/reach-avoid-2-2d.py', 'models/dubins/dubinsControl_2dKinematic.py')
    ...
    my_id = "myRobot"
    my_code = None
    my_filename = currFile.replace('synthesis/FACTEST/omega_FACTEST/reach-avoid-2-2d.py', 'models/dubins/bijectiveControl.py')
...
b_goal3 = np.array([-5,7,7,-5])
b_goal4 = np.array([7,-5,-5,7])
...
E7 = pc.Polytope(A, b_unsafe1) # unsafe border 1
E8 = pc.Polytope(A, b_unsafe2) # unsafe border 2
E9 = pc.Polytope(A, b_unsafe3) # unsafe border 3
E10 = pc.Polytope(A, b_unsafe4) # unsafe border 4

env = {'E1':E1, 'E2':E2, 'E3':E3, 'E4':E4, 'E5':E5, 'E6':E6}
borders = [E7, E8, E9, E10]
...
import csv
with open('/Users/krismiller/Desktop/dissertation/synthesis/FACTEST/omega_FACTEST/results/RA2_'+system+'.csv', 'w', newline='') as csvfile:

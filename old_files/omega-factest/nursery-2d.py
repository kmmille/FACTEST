...
modelPath = currFile.replace('/synthesis/FACTEST/omega_FACTEST/nursery-2d.py', '')
sys.path.append(modelPath)
sys.path.append(modelPath+'/utils/')
modelPath = currFile.replace('/nursery-2d.py', '')
sys.path.append(modelPath)
...
if system == 'car':
    my_id = "myCar"
    my_code = None
    my_filename = currFile.replace('synthesis/FACTEST/omega_FACTEST/nursery-2d.py', 'models/dubins/dubinsControl_2dKinematic.py')
    ...
    my_id = "myRobot"
    my_code = None
    my_filename = currFile.replace('synthesis/FACTEST/omega_FACTEST/nursery-2d.py', 'models/dubins/bijectiveControl.py')
...
b_init = np.array([6,-5,0.5,0.5])

b_goal1 = np.array([-5,7,-5,7]) # b - baby
b_goal2 = np.array([7,-5,7,-5]) # c - charger
b_goal3 = np.array([-5,7,7,-5]) # a - adult
...
b_unsafe5 = np.array([2.5,-2,11,4])
b_unsafe6 = np.array([-2,11,0.5,0.5])
b_unsafe7 = np.array([2.5,-2,-9,11])
b_unsafe8 = np.array([-2,2.5,-9,11])
b_unsafe9 = np.array([-2,2.5,11,-9])

...
modelPath = currFile.replace('/synthesis/FACTEST/omega_FACTEST/reach-avoid-1-3d.py', '')
sys.path.append(modelPath)
sys.path.append(modelPath+'/utils/')

modelPath = currFile.replace('/reach-avoid-1-3d.py', '')
sys.path.append(modelPath)
...
if system == 'hovercraft':
    ...
    my_id = "myCar"
    my_code = None
    my_filename = currFile.replace('synthesis/FACTEST/omega_FACTEST/reach-avoid-1-3d.py', 'models/dubins/hovercraftControl.py')
    ...
    my_id = "myCar"
    my_code = None
    my_filename = currFile.replace('synthesis/FACTEST/omega_FACTEST/reach-avoid-1-3d.py', 'models/dubins/auvControl.py')
...
b_goal2 = np.array([6.5,-5.5,6.5,-5.5,6.5,-5.5])
...
b_unsafe7 = np.array([11,11,11,11,11,-10])
b_unsafe8 = np.array([11,11,11,11,-10,11])

b_unsafe5 = np.array([11,-2,1,1,11,11])
b_unsafe6 = np.array([-2,11,1,1,11,11])
...
E5 = pc.Polytope(A, b_unsafe1)
E6 = pc.Polytope(A, b_unsafe2)
E7 = pc.Polytope(A, b_unsafe4)
E8 = pc.Polytope(A, b_unsafe3)
E9 = pc.Polytope(A, b_unsafe7)
E10 = pc.Polytope(A, b_unsafe8)
...
print('starting hybrid construction')
hybrid = constructFullHybrid(ltl_formula=ltl_formula, env=env, system=my_car, initial_set=initial_set, border_sets=[E5,E6,E7,E8,E9,E10])
...
import csv
with open('/Users/krismiller/Desktop/dissertation/synthesis/FACTEST/omega_FACTEST/results/RA4_'+system+'.csv', 'w', newline='') as csvfile:
